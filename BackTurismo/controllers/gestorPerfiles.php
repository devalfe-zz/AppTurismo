...
class GestorPerfiles{
	...
	public function guardarPerfilController(){
		...
		if(isset($_POST["nuevoUsuario"])){	
			...
			if(isset($_FILES["nuevaImagen"]["tmp_name"])){
				...
				$ruta = "themes/admin/images/perfiles/perfil".$aleatorio.".jpg";
			...
			if($ruta == ""){
				...
				$ruta = "themes/admin/images/photo.jpg";	
			...
			if(preg_match('/^[a-zA-Z0-9]+$/', $_POST["nuevoUsuario"])&&
			   ...
			   preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["nuevoEmail"])){
				...
				$respuesta = GestorPerfilesModel::guardarPerfilModel($datosController, "dev7_user_turismo");
	...
	public function verPerfilesController(){
		...
		$respuesta = GestorPerfilesModel::verPerfilesModel("dev7_user_turismo");	
	...
	public function editarPerfilController(){
		...
		if(isset($_POST["editarUsuario"])){	
			...
			if($ruta != "" && $_POST["editarPhoto"] != "themes/admin/images/photo.jpg"){
			...
			if(preg_match('/^[a-zA-Z0-9]+$/', $_POST["editarUsuario"])&&
			   ...
			   preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["editarEmail"])){
				...
				$respuesta = GestorPerfilesModel::editarPerfilModel($datosController, "dev7_user_turismo");
	...
	public function borrarPerfilController(){
		...
		if(isset($_GET["idBorrar"])){
			...
			$respuesta = GestorPerfilesModel::borrarPerfilModel($datosController, "dev7_user_turismo");
