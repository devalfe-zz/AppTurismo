...
class GestorArticulosModel{
	...
	static public function guardarArticuloModel($datosModel, $tabla){
		$stmt = (new Conexion)->conectar()->prepare("INSERT INTO $tabla (titulo, direccion, introduccion, ruta, rutai, rutaii, contenido) VALUES (:titulo, :direccion :introduccion, :ruta, :rutai, :rutaii, :contenido)");
	...
	static public function mostrarArticulosModel($tabla){
		...
		$stmt = (new Conexion)->conectar()->prepare("SELECT id, titulo, direccion, introduccion, ruta,  rutai, rutaii, contenido FROM $tabla ORDER BY orden ASC");
