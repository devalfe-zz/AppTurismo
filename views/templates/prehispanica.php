    ...
    <section class="bienvenidos">
        <?php include "views/templates/header.php";?>
            <div class="text-encabezado text-center">
                <div class="container">
                    <h1 class="display-4 wow slideInLeft">MOQUEGUA PREHISPÁNICA</h1>
                    <p class="wow bounceIn" data-wow-delay=".3s">Un pasado prehispánico que se remonta a los 12,000 a.C.</p>
                </div>
            </div>
    </section>
    <div class="ruta">
        <div class="container">
            <row>
                <div class=" bar col-12 text-right">
                    <a href="index.php">Inicio</a> » Moquegua Prehispánica
                </div>
            </row>
        </div>
    </div>
    <section class="py-2">
            ...
            <div class="panels">
                        ...
                        <div class="panel panel2">
                            ...
                            <p>MUSEO CONTISUYO</p>
                            <p class="col-2 m-5">Las muestras permanentes constan de cerámicos, fardos funerarios, joyería, restos humanos y animales, tejidos, vestimentas y otros restos prehispánicos.</p>
                        </div>
                        <div class="panel panel3">
                            <p class="col-2 m-5">Se encuentra a 20 min de Torata, tomando la carretera Binacional. Es un conjunto urbano perteneciente a la cultura inca. Alrededor de la ciudadela se halla un antiguo sistema de andenería; la ciudadela es atravesada por el Cápac Ñan, una extensa red de caminos diseñada por los incas para unir los principales pueblos con la sede del imperio.</p>
                            <p>CAMATA</p>
                            <p class="col-2 m-5">Desde la cima se observa el impresionante Cerro Baúl y cautivador paisaje. Los meses idóneos para su visita son entre diciembre y marzo, pues las lluvias favorecen el crecimiento de la vegetación, tornando toda la zona en un jardín.</p>
                        </div>
                        <div class="panel panel4">
                            <p class="col-2 m-5">Se halla ubicado a 30 min. de la ciudad. El cerro Baúl es el Apu tutelar más importante de la costa sur peruana.  </p>
