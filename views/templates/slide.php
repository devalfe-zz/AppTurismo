            ...
            <div class="carousel-caption carousel-style-left">
                <div class="text-encabezado text-center text-sm-right">
                    <div class="container">
                        ...
                        <p class="text-uppercase wow fadeInUp" data-wow-duration="2s" data-wow-delay="2s">La ciudad de Moquegua presenta una arquitectura tradicional que por su valor histórico y artístico</p> <a href="#" class="btn btn-outline-primary btn-lg wow fadeInUp" data-wow-duration="2s" data-wow-delay="3s">Contactanos</a>
                    </div>
                </div>
            </div>
        </div>
