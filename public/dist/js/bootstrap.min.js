 ...
 */
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript."); + function(a) {
    ...
    var d = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(a) {
        ...
        g = (function(a) {
            var b = "alert",
                ...
                o = function() {
                    ...
                    return b.prototype.close = function(a) {
                        ...
                        var c = this;
                        return a(b).removeClass(n.SHOW), f.supportsTransitionEnd() && a(b).hasClass(n.FADE) ? void a(b).one(f.TRANSITION_END, function(a) {
            ...
            var b = "carousel",
                ...
                u = function() {
                    ...
                    return j.prototype.next = function() {
                        ...
                        var b = this;
                        this._config.keyboard && a(this._element).on(r.KEYDOWN, function(a) {
                            return b._keydown(a)
                        }), "hover" !== this._config.pause || "ontouchstart" in document.documentElement || a(this._element).on(r.MOUSEENTER, function(a) {
                            return b.pause(a)
                        }).on(r.MOUSELEAVE, function(a) {
                            return b.cycle(a)
                        })
                    }, j.prototype._keydown = function(a) {
                        if (!/input|textarea/i.test(a.target.tagName)) switch (a.preventDefault(), a.which) {
                            case m:
                                this.prev();
                                break;
                            case n:
                        ...
                        var m = this._triggerSlideEvent(g, k);
                        if (!m.isDefaultPrevented() && e && g) {
                            this._isSliding = !0, h && this.pause(), this._setActiveIndicatorElement(g);
                            var n = a.Event(r.SLID, {
                                relatedTarget: g,
                                direction: k
                            });
                            f.supportsTransitionEnd() && a(this._element).hasClass(s.SLIDE) ? (a(g).addClass(j), f.reflow(g), a(e).addClass(i), a(g).addClass(i), a(e).one(f.TRANSITION_END, function() {
                                a(g).removeClass(i + " " + j).addClass(s.ACTIVE), a(e).removeClass(s.ACTIVE + " " + j + " " + i), d._isSliding = !1, setTimeout(function() {
                                    return a(d._element).trigger(n)
                                }, 0)
                            }).emulateTransitionEnd(l)) : (a(e).removeClass(s.ACTIVE), a(g).addClass(s.ACTIVE), this._isSliding = !1, a(this._element).trigger(n)), h && this.cycle()
                        }
            ...
            var b = "collapse",
                ...
                s = function() {
                    ...
                    return i.prototype.toggle = function() {
                        a(this._element).hasClass(p.SHOW) ? this.hide() : this.show()
                        ...
                        if (!a(this._element).hasClass(p.SHOW)) {
                            var c = void 0,
                                d = void 0;
                            if (this._parent && (c = a.makeArray(a(this._parent).find(r.ACTIVES)), c.length || (c = null)), !(c && (d = a(c).data(h), d && d._isTransitioning))) {
                                ...
                                if (a(this._element).trigger(e), !e.isDefaultPrevented()) {
                                    ...
                                    var j = function() {
                                        a(b._element).removeClass(p.COLLAPSING).addClass(p.COLLAPSE).addClass(p.SHOW), b._element.style[g] = "", b.setTransitioning(!1), a(b._element).trigger(o.SHOWN)
                                    };
                    ...
                    return b.prototype.toggle = function() {
                        ...
                        if (!c || c.which !== n) {
                            ...
                            for (var e = a.makeArray(a(q.DATA_TOGGLE)), f = 0; f < e.length; f++) {
                                ...
                                if (a(g).hasClass(p.SHOW) && !(c && "click" === c.type && /input|textarea/i.test(c.target.tagName) && a.contains(g, c.target))) {
            ...
            var b = "modal",
                ...
                t = function() {
                    function j(b, d) {
                        c(this, j), this._config = this._getConfig(d), this._element = b, this._dialog = a(b).find(s.DIALOG)[0], this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._originalBodyPadding = 0, this._scrollbarWidth = 0
                    }
                    return j.prototype.toggle = function(a) {
                        ...
                        f.supportsTransitionEnd() && a(this._element).hasClass(r.FADE) && (this._isTransitioning = !0);
                        var d = a.Event(q.SHOW, {
                            relatedTarget: b
                        });
                        a(this._element).trigger(d), this._isShown || d.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), a(document.body).addClass(r.OPEN), this._setEscapeEvent(), this._setResizeEvent(), a(this._element).on(q.CLICK_DISMISS, s.DATA_DISMISS, function(a) {
                            return c.hide(a)
                        ...
                        a(this._element).trigger(e), this._isShown && !e.isDefaultPrevented() && (this._isShown = !1, this._setEscapeEvent(), this._setResizeEvent(), a(document).off(q.FOCUSIN), a(this._element).removeClass(r.SHOW), a(this._element).off(q.CLICK_DISMISS), a(this._dialog).off(q.MOUSEDOWN_DISMISS), d ? a(this._element).one(f.TRANSITION_END, function(a) {
                            return c._hideModal(a)
                        }).emulateTransitionEnd(l) : this._hideModal())
                    }, j.prototype.dispose = function() {
                        a.removeData(this._element, h), a(window, document, this._element, this._backdrop).off(i), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._originalBodyPadding = null, this._scrollbarWidth = null
                    }, j.prototype._getConfig = function(c) {
                        return c = a.extend({}, o, c), f.typeCheckConfig(b, c, p), c
                        ...
                        var b = this;
                        this._isShown ? a(window).on(q.RESIZE, function(a) {
                        ...
                        if (this._isShown && this._config.backdrop) {
                            ...
                            if (this._backdrop = document.createElement("div"), this._backdrop.className = r.BACKDROP, d && a(this._backdrop).addClass(d), a(this._backdrop).appendTo(document.body), a(this._element).on(q.CLICK_DISMISS, function(a) {
                                ...
                                }), e && f.reflow(this._backdrop), a(this._backdrop).addClass(r.SHOW), !b) return;
                            if (!e) return void b();
            ...
            var b = "scrollspy",
                ...
                r = function() {
                    function j(b, d) {
                        var e = this;
                        c(this, j), this._element = b, this._scrollElement = "BODY" === b.tagName ? window : b, this._config = this._getConfig(d), this._selector = this._config.target + " " + p.NAV_LINKS + "," + (this._config.target + " " + p.DROPDOWN_ITEMS), this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, a(this._scrollElement).on(n.SCROLL, function(a) {
                            return e._process(a)
                    ...
                    return j.prototype.refresh = function() {
                    ...
                    }, j.prototype._getOffsetHeight = function() {
                        ...
                        return this.each(function() {
                            var c = a(this).data(h),
                                e = "object" === ("undefined" == typeof b ? "undefined" : d(b)) && b;
                            if (c || (c = new j(this, e), a(this).data(h, c)),
                                "string" == typeof b) {
                ...
                o = function() {
                    ...
                    return b.prototype.show = function() {
                        ...
                        var e = this,
                            ...
                            i = function() {
                                return e._transitionComplete(b, g, h, d)
                            };
            ...
            var b = "tooltip",
                ...
                v = function() {
                    function j(a, b) {
                        c(this, j), this._isEnabled = !0, this._timeout = 0, this._hoverState = "", this._activeTrigger = {}, this._isTransitioning = !1, this._tether = null, this.element = a, this.config = this._getConfig(b), this.tip = null, this._setListeners()
                    }
                    return j.prototype.enable = function() {
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            var h = "function" == typeof this.config.placement ? this.config.placement.call(this, e, this.element) : this.config.placement,
                                ...
                                k = this.config.container === !1 ? document.body : a(this.config.container);
                            a(e).data(this.constructor.DATA_KEY, this).appendTo(k), a(this.element).trigger(this.constructor.Event.INSERTED), this._tether = new Tether({
                                ...
                                addTargetClasses: !1
                            }), f.reflow(e), this._tether.position(), a(e).addClass(r.SHOW);
                            var m = function() {
                                var c = b._hoverState;
                        ...
                        if (this._isTransitioning) throw new Error("Tooltip is transitioning");
                        var g = function() {
                            c._hoverState !== p.SHOW && d.parentNode && d.parentNode.removeChild(d), c.element.removeAttribute("aria-describedby"), a(c.element).trigger(c.constructor.Event.HIDDEN), c._isTransitioning = !1, c.cleanupTether(), b && b()
                        };
                        a(this.element).trigger(e), e.isDefaultPrevented() || (a(d).removeClass(r.SHOW), f.supportsTransitionEnd() && a(this.tip).hasClass(r.FADE) ? (this._isTransitioning = !0, a(d).one(f.TRANSITION_END, g).emulateTransitionEnd(k)) : g(), this._hoverState = "")
